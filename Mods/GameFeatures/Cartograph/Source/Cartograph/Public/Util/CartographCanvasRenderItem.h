...
#include "CanvasTypes.h"
 ...
 // Copied entire FCanvasBatchedElementRenderItem cuz I can't inherit from it because the functions aren't exposed to modules,
 // thus causes link errors.
class FCartographCanvasRenderItem : public FCanvasBaseRenderItem
{
public:
	/**
	* Init constructor
	*/
	FCartographCanvasRenderItem(
		FBatchedElementParameters* InBatchedElementParameters = nullptr,
		const FTexture* InTexture = nullptr,
	...
	*/
	virtual ~FCartographCanvasRenderItem() override
	{
		delete Data;
	}
